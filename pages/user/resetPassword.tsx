    ...
    const validatePasswordFormat = (password: string) => {
        ...
        if (!letterRegex.test(password)) {
            setPasswordFormatError(
                "Password must use only letters and numbers."
            );
            return false;
        }
        if (!regex.test(password)) {
            setPasswordFormatError(
                "Password must be between 8 and 24 letters."
            );
            return false;
        }
        setPasswordFormatError("");
            ...
            >
                ...
                <Grid item sx={{ mt: 1, px: 1 }}>
                    ...
                    <Typography
                        ...
                        fontWeight="bold"
                    >
                        Password must contains only letters and numbers. And
                        must be between 8 and 24 letters.
                    </Typography>
                </Grid>
                    ...
                    {isLoading ? (
                        ...
                        <>
                            <Typography color="#1B9B41" fontWeight="bold">
                                Password reset completed. Please try logging in
